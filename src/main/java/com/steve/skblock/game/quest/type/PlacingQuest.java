...
public class PlacingQuest implements SkyblockQuest {
    ...
    public PlacingQuest(String id, String title, String description, Material material, int targetAmount, String nextQuestId) {
        this.id = id;
        this.title = title;
