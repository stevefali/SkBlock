...
public class CraftingQuest implements SkyblockQuest {
    ...
    public CraftingQuest(String id, String title, String description, Material material, int targetAmount, String nextQuestId) {
        this.id = id;
        this.title = title;
